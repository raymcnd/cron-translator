...
export default function ExpressionForm2() {
    ...
    return (
        ...
        <h4 className="mb-3">Expression Form 2</h4>
        <div className="d-flex mb-3" style={{ gap: "2.5%" }}>
            <input type="text" style={{width: "18%"}} name="minute" onChange={handleInputChange}></input>
            <input type="text" style={{width: "18%"}} name="houre" onChange={handleInputChange}></input>
            <input type="text" style={{width: "18%"}} name="dayMonth" onChange={handleInputChange}></input>
            <input type="text" style={{width: "18%"}} name="month" onChange={handleInputChange}></input>
            <input type="text" style={{width: "18%"}} name="dayWeek" onChange={handleInputChange}></input>
        </div>
